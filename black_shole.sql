...
-- Test for Black-Scholes Option Pricing
SELECT * FROM black_scholes_option_pricing(
    100.0,    -- Current stock price
    100.0,    -- Strike price of the option
    1.0,      -- Time to maturity in years
    0.05,     -- Risk-free interest rate
    0.2       -- Volatility of the stock
);
